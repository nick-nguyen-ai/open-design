  ...
  zones: {
    ...
    zones: [
      ...
      },
      {
        ...
        label: 'Dashboards',
        nodes: [
          { id: 'cockpit', label: 'Monitoring Cockpit' },
          { id: 'tower', label: 'Control Tower' },
          { id: 'dq', label: 'Data Quality Ops' },
        ],
      },
      {
        id: 'proj',
      ...
      },
      {
        ...
        nodes: [
          { id: 'studio', label: 'Data-Scientist Studio' },
      ...
      },
      {
        ...
        nodes: [
          ...
          { id: 'lineage', label: 'Data Lineage Map' },
          { id: 'postmortem', label: 'Incident Postmortem' },
        ],
      },
    ],
    links: [
