...
export default makeCollectionManifest({
  ...
  familyName: 'Circuit',
  kind: 'sequence',
  description: 'Neon-terminal sequence: session panes, phosphor message traces, live reply dashes.',
  searchText: 'circuit neon dark terminal glow sequence diagram lifelines messages protocol',
  grammarId: 'neon-circuit',
  sourceFile: 'packages/diagram-collections/src/circuit/CircuitSequence.tsx',
  exportName: 'CircuitSequence',
  motionLevel: 2,
  themeModes: ['dark'],
  knownLimitations: [
