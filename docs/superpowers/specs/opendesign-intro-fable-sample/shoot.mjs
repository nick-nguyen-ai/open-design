 ...
 * system intro deck (`/demo/opendesign-intro-fable`, THE LIT BOARD template).
 *
 ...
 *
 * Run from repo root: `node docs/superpowers/specs/opendesign-intro-fable-sample/shoot.mjs`
 */
...
// Repo root: docs/superpowers/specs/opendesign-intro-fable-sample -> up four dirs.
...
const ROUTE = '/demo/opendesign-intro-fable';
