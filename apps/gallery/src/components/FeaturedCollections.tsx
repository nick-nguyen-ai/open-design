...
export function FeaturedCollections({ onApply }: FeaturedCollectionsProps) {
  return (
    <section aria-labelledby="collections-heading" className="flex flex-col gap-4">
      <h2 id="collections-heading" className="font-heading text-lg font-weight-semibold text-text-primary">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
        {COLLECTIONS.map((collection) => (
          ...
          >
            ...
            <span className="mt-auto inline-flex items-center gap-1 pt-1 text-xs font-weight-medium text-accent">
